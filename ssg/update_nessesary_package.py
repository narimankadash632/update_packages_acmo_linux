...
# Загружаем переменные из .env_ssg
load_dotenv(".env_ssg")
...
command = f"ansible-playbook -i /home/kuat.saparov/ansible/inventory /home/kuat.saparov/ansible/update_packages_test_ssg.yml --extra-vars 'ansible_sudo_pass={ansible_pass}'"
