...
# Загружаем переменные из .env_dgok
load_dotenv(".env_dgok")
...
command = f"ansible-playbook -i /home/kuat.saparov/ansible/hosts /home/kuat.saparov/ansible/update_packages_test_dgok.yml --extra-vars 'ansible_sudo_pass={ansible_pass}'"
