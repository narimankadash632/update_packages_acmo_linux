...
# Загружаем переменные из .env_akt
load_dotenv(".env_akt")
...
command = f"ansible-playbook -i /home/kuat.saparov/ansible/hosts /home/kuat.saparov/ansible/update_packages_test_akt.yml --extra-vars 'ansible_sudo_pass={ansible_pass}'"
