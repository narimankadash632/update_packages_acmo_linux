...
# Загружаем переменные из .env_eec
load_dotenv(".env_eec")
...
command = f"ansible-playbook -i /home/kuat.saparov/ansible/inventory /home/kuat.saparov/ansible/update_packages_test_eec.yml --extra-vars 'ansible_sudo_pass={ansible_pass}'"
